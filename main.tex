...
\begin{frame}{The evolutions of ISO Standards to clarify communications}
\kern -.3in
...
\begin{frame}{ISO29110 standard for very smal enterprizes}
\begin{itemize}
\item Less that 20 employees
\item focuses on the essentials of practical quality control
\end{itemize}
$$\includegraphics[width=.85\textwidth]{overview.png}$$
\end{frame}
...
\null
\kern -.5in
$$\includegraphics[width=.9\textwidth]{redmine.png}$$
\end{frame}

\begin{frame}{www.gitlab.com}
\null
\kern -.5in
$$\includegraphics[width=.9\textwidth]{gitlab.png}$$
\end{frame}

\begin{frame}{www.github.com}
\null
\kern -.5in
$$\includegraphics[width=.9\textwidth]{github.png}$$
\end{frame}
\endinput
